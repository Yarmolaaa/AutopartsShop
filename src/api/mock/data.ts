...
export const products: Product[] = [
  ...
  { id: 2,  title: 'Гальмівний диск TRW DF4075',           description: 'Вентильований гальмівний диск TRW діаметром 280 мм. Підходить для Renault Megane II, Scenic II. Термостійке покриття проти корозії.',                    price: 1290,  category: 'Гальмівна система', image: `${import.meta.env.BASE_URL}/images/BrakeDiscTRW.jpg`, rating: 4.6, stock: 18 },
